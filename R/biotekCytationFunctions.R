...
#'
#' @param data_file path to a .csv, .xls or .xlsx file from Biotek Cytation plate reader
...
#' @examples
#' \dontrun{
#' cytation_parse(data_file = "examples/plate_reader/biotek_cytation/231031_pr_calibration_lid.xlsx",
#'                 layout_csv = "examples/plate_reader/biotek_cytation/plate_layout.csv",
#'                 timeseries = FALSE)
#' }
cytation_parse <- function(data_file, layout_csv, timeseries=T, data_csv) {
  if (!missing(data_csv)) {
    warning("The 'data_csv' argument of cytation_parse() is deprecated; ",
