...
```{r echo=FALSE, message=FALSE, include=TRUE, fig.align='center'}
knitr::include_graphics("examples/plate_reader/DATA/191219_calibration_membrane_parsed_absorbance_cfs.pdf")
```
...
```{r echo=FALSE, message=FALSE, include=TRUE, fig.align='center'}
knitr::include_graphics("examples/flow_cytometry/DATA/20191121/pWeak_None_0_1_processed_processed.pdf")
```
